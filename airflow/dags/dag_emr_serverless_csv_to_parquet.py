...
S3_BUCKET_OUTPUT = "cjmm-mds-lake-staged"
...
def dag_emr_serverless_csv_to_parquet():
    ...
    emr_job = EmrServerlessStartJobOperator(
        ...
        job_driver={
            "sparkSubmit": {
                "entryPoint": f"s3://{S3_BUCKET_CONFIG}/scripts/emr/emr_csv_to_parquet.py",
                "entryPointArguments": [
                    f"s3://{S3_BUCKET_INPUT}/sales/amazon.csv",
                    f"s3://{S3_BUCKET_OUTPUT}/emr_serverless_example/output_parquet/"
                ],
